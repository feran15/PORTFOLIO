  ...
  return (
    <section className='pt-16' id='contact'>
        <div>
            ...
            <form method='POST' action="https://getform.io/f/9927400a-d3d7-4b85-821e-645a69375849" className='flex flex-col container mx-auto w-[50%] space-y-5 py-6' data-aos='zoom-in'>
