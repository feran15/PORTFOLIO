...
export const Contact = () => {
  ...
  return (
    <section className="pt-16" id="contact">
      <div>
        <h1
          className="font-bold text-lg md:text-xl inline border-b-2 border-[#C8CACD] ml-20"
          data-aos="fade-up"
        >
          Contact me
        </h1>
        <p className="ml-20 mt-2 text-sm md:text-base" data-aos="fade-up">
          Send me a message💬
        </p>
        <form
          method="POST"
          action="https://getform.io/f/9927400a-d3d7-4b85-821e-645a69375849"
          className="flex flex-col container mx-auto w-[60%] md:w-[50%] space-y-5 py-6"
          data-aos="zoom-in"
        >
          <input
            type="text"
